...
Terminal Emulator Project. Fun backwards (retro?) side project to implement information.
...
<li>arugment parsing</li>
<li>some fun addons (magic 8 ball app)</li>
<li>additional navigation commands</li>
</ul>
</ol>
</p>
